...
public class Reinforcements extends DrillBase {
    ...
    private static final VoxelShape SHAPE_NORTH = Stream.of(
            ...
            Block.makeCuboidShape(6, -15, 6, 10, 0, 10),
            Block.makeCuboidShape(16, 6, 6, 31, 10, 10),
            Block.makeCuboidShape(0, 31, 0, 16, 32, 16),
            Block.makeCuboidShape(0, -16, 0, 16, -15, 16),
            Block.makeCuboidShape(-16, 0, 0, -15, 16, 16),
            Block.makeCuboidShape(31, 0, 0, 32, 16, 16),
            Block.makeCuboidShape(10, 0, 0, 16, 16, 16),
            Block.makeCuboidShape(6, 10, 0, 10, 16, 16),
            Block.makeCuboidShape(6, 0, 0, 10, 6, 16),
            Block.makeCuboidShape(6, 16, 6, 10, 31, 10)
    ...
    private static final VoxelShape SHAPE_EAST = Stream.of(
            ...
            Block.makeCuboidShape(0, 31, 0, 16, 32, 16),
            Block.makeCuboidShape(0, -16, 0, 16, -15, 16),
            Block.makeCuboidShape(0, 0, -16, 16, 16, -15),
            Block.makeCuboidShape(0, 0, 31, 16, 16, 32),
    ...
    public Reinforcements(final Properties properties) {
        super(properties);
    }
