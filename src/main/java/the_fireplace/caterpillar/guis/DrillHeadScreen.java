...
public class DrillHeadScreen extends ContainerScreen<DrillHeadContainer> {
    ...
    public enum GUI_TABS {
        MAIN((byte)0, I18n.format(Caterpillar.MOD_ID.concat(".gui.main")), false, new ResourceLocation(Caterpillar.MOD_ID, "textures/gui/guicaterpiller.png")),
        DECORATION((byte)1, I18n.format(Caterpillar.MOD_ID + "gui.main"), false, new ResourceLocation(Caterpillar.MOD_ID, "textures/gui/guicaterpiller.png")),
        REINFORCEMENT((byte)2, I18n.format(Caterpillar.MOD_ID + "gui.main"), false, new ResourceLocation(Caterpillar.MOD_ID, "textures/gui/guicaterpiller.png")),
        INCINERATOR((byte)3, I18n.format(Caterpillar.MOD_ID + "gui.main"), false, new ResourceLocation(Caterpillar.MOD_ID, "textures/gui/guicaterpiller.png"));
    ...
    public DrillHeadScreen(DrillHeadContainer screenContainer, PlayerInventory inventory, IInventory dispenserInventory, CaterpillarData caterpillarData,ITextComponent titleIn) {
    ...
    private void drawGuiIncineratorBackgroundLayer(MatrixStack matrixStack) {
        ...
        this.minecraft.getTextureManager().bindTexture(GUI_TABS.INCINERATOR.guiTextures);
    ...
    private void drawGuiReinforcementBackgroundLayer(MatrixStack matrixStack) {
        RenderSystem.color4f(1.0f, 1.0f, 1.0f, 1.0f);
        this.minecraft.getTextureManager().bindTexture(GUI_TABS.REINFORCEMENT.guiTextures);
        int x  = (this.width - this.xSize) / 2;
        int y = (this.height - this.ySize) / 2;
        this.blit(matrixStack, x, y, 0, 0, this.xSize, this.ySize);
        GuiUtils.drawTexturedModalRect(x, y, 0, 0, this.xSize, this.ySize, 0.f);
    ...
    private void drawGuiDecorationBackgroundLayer(MatrixStack matrixStack) {
        RenderSystem.color4f(1.0f, 1.0f, 1.0f, 1.0f);
        this.minecraft.getTextureManager().bindTexture(GUI_TABS.DECORATION.guiTextures);
        int x  = (this.width - this.xSize) / 2;
        int y = (this.height - this.ySize) / 2;
        this.blit(matrixStack, x, y, 0, 0, this.xSize, this.ySize);
        GuiUtils.drawTexturedModalRect(x, y, 0, 0, this.xSize, this.ySize, 0.f);
    ...
    private void drawGuiMainBackgroundLayer(MatrixStack matrixStack) {
        RenderSystem.color4f(1.0f, 1.0f, 1.0f, 1.0f);
        this.minecraft.getTextureManager().bindTexture(GUI_TABS.MAIN.guiTextures);
        int x  = (this.width - this.xSize) / 2;
        int y = (this.height - this.ySize) / 2;
        this.blit(matrixStack, x, y, 0, 0, this.xSize, this.ySize);
        GuiUtils.drawTexturedModalRect(x, y, 0, 0, this.xSize, this.ySize, 0.f);
    ...
    private void drawTabsHover(GUI_TABS tabHoveredOver, MatrixStack matrixStack) {
        int i = (int)this.minecraft.mouseHelper.getMouseX() * this.width / this.minecraft.currentScreen.width;
        int j = this.height - (int)this.minecraft.mouseHelper.getMouseY() * this.height / this.minecraft.currentScreen.height - 1;
    ...
    private void drawTabsForeground(GUI_TABS tabToDraw, MatrixStack matrixStack) {
        RenderSystem.color4f(1.0f, 1.0f, 1.0f, 1.0f);
        this.minecraft.getTextureManager().bindTexture(tabToDraw.guiTextures);
        int x = (this.width - this.xSize) / 2;
        int y = (this.height - this.ySize) / 2;
    ...
    private void drawGuiMainForegroundLayer(MatrixStack matrixStack) {
        this.font.drawString(matrixStack, I18n.format("gui.main.consumption"), 2, -8, Color.WHITE.getRGB());
        this.font.drawString(matrixStack, I18n.format("gui.main.gathered"), 120, -8, Color.WHITE.getRGB());
    }
}
