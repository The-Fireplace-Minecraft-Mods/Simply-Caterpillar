...
public class IncineratorContainerData extends SimpleContainerData {

    private final IncineratorBlockEntity blockEntity;

    public IncineratorContainerData(IncineratorBlockEntity blockEntity, int amount) {
        super(amount);
