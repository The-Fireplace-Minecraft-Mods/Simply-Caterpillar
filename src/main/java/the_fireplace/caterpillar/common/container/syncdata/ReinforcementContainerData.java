...
public class ReinforcementContainerData extends SimpleContainerData {

    private final ReinforcementBlockEntity blockEntity;

    public ReinforcementContainerData( ReinforcementBlockEntity blockEntity, int amount) {
        super(amount);
