...
public class ReinforcementScreen extends AbstractContainerScreen<ReinforcementContainer> {
    ...
    public ReinforcementScreen(ReinforcementContainer container, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(PoseStack stack, float mouseX, int mouseY, int partialTicks) {
        ...
        bindTexture();
        blit(stack, this.leftPos, this.topPos, 0, 0, imageWidth, imageHeight);
    }
