 ...
 */
@Mod(modid = VersionChecker.MODID, name = VersionChecker.MODNAME, version = VersionChecker.VERSION, guiFactory = "the_fireplace.caterpillar.VersionChecker$VCGui")
public class VersionChecker {
    static final String HostMODID = Caterpillar.MODID;
    private static final String HostMODNAME = Caterpillar.MODNAME;
    ...
    public VersionChecker() {
        curseCode = Caterpillar.curseCode;
    }
    ...
    public void init(FMLInitializationEvent event) {
        if (hostFailed()) {
            HostVERSION = Caterpillar.VERSION;
            tryNotifyDynious();
