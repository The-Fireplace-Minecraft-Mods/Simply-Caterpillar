...
public class DrillHeadScreen extends AbstractScrollableScreen<DrillHeadMenu> {
    ...
    protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        graphics.drawString(this.font, DrillHeadBlockEntity.CONSUMPTION_TITLE, consumptionX, consumptionY, 0x404040, false);
        graphics.drawString(this.font, DrillHeadBlockEntity.GATHERED_TITLE, gatheredX, gatheredY, 0x404040, false);
        graphics.drawString(this.font, super.playerInventoryTitle, super.inventoryLabelX, super.inventoryLabelY, 0x404040, false);
    }
