...
public class DecorationSyncCurrentMapS2CPacket {
    ...
    public static final ResourceLocation PACKET_ID = new ResourceLocation(Caterpillar.MOD_ID, "decoration.current_map_sync_s2c");

    public static void send(ServerLevel level, int currentMap, BlockPos pos) {
