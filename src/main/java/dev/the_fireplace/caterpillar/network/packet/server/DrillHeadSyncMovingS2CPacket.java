...
public class DrillHeadSyncMovingS2CPacket {
    ...
    public static final ResourceLocation PACKET_ID = new ResourceLocation(Caterpillar.MOD_ID, "drill_head.moving_sync_s2c");

    public static void send(ServerLevel level, boolean moving, BlockPos pos) {
